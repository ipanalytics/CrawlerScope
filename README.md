...
- `official_embedded_json`: machine-readable JSON embedded in an operator page.
...
- Search crawlers: Google, Bing, DuckDuckGo, Applebot, MojeekBot, Naver Yeti, YandexBot, Baiduspider
- AI crawlers/fetchers: OpenAI, Perplexity, Anthropic, Amazonbot, DuckAssistBot, MistralAI-User, Meta, Bytespider
- SEO crawlers: AhrefsBot, Lumar, SemrushBot
- Ad verification crawlers: IAS crawler, TTD-Content
- Security scanners: Censys, Shodan
- Monitoring probes: Datadog Synthetics, UptimeRobot, Pingdom, Better Stack, StatusCake
- Archive/social/analytics: Common Crawl, Flipboard, Parse.ly, Pinterestbot, LinkedInBot
